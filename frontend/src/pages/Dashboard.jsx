...
import { Form, Input, InputNumber, Space, Divider, Row, Col, Select } from "antd";
...
export default function Dashboard() {
  ...
  let admin = adminList && adminList.filter(res =>
    res._id == JSON.parse(localStorage.getItem('auth')).current.id
  )[0];

  useEffect(() => {
    if (adminList) {
      admin = adminList.filter(res =>
        res._id == JSON.parse(localStorage.getItem('auth')).current.id
      )[0];
  ...
  const moveToNextTable = (job) => {
    ...
    const nextTable = Object.keys(dOptions)[Object.keys(dOptions).indexOf(currentTable) + 1];
    ...
    <DashboardLayout>
      {
        statusModal && (
          <div className="modal">
            <div onClick={toggleModal1} className="overlay" style={{
              background: "rgba(49,49,49,0.8)", width: "100vw",
              height: "100vh",
              top: 0,
              left: 0,
              right: 0,
              ...
              <Form onFinish={changeStatus}>
                ...
                <Form.Item label="Status" name="status">
                  <Select
                    ...
                    options={jobStatus && Object.values(dOptions).filter(j => {
                      return j.some(obj => {
                        if (jobStatus['status'] == 'pending' && obj.value == 'requirement received') {
                          return true;
                        }
        ...
        <Col className="gutter-row" span={8}>
          <div className="whiteBox shadow" style={{ height: "380px" }}>
            ...
            >
              ...
              <a href="/vendor" target="_blank">  Add New Vendor</a>
              <br />
              <a href="/lead" target="_blank"> Add New Job</a>
              <br />
              <a href="/product" target="_blank"> Add New Services</a>
              <br />
      ...
      <Row gutter={[24, 24]}>
        <Col className="gutter-row" span={24}>
          <div className="whiteBox shadow">
            ...
            <RecentTable entity={"job"} name="schedule" dataTableColumns={leadColumns} moveToNextTable={moveToNextTable} dOptions={dOptions} jobStatus={jobStatus} />
        ...
        <Col className="gutter-row" span={24}>
          <div className="whiteBox shadow">
            ...
            <RecentTable entity={"job"} name="start" dataTableColumns={productColumns} moveToNextTable={moveToNextTable} dOptions={dOptions} jobStatus={jobStatus} />
            <i className="bi bi-arrow-down" style={{ color: "black" }}></i>
          </div>
        </Col>
        <Col className="gutter-row" span={24}>
          <div className="whiteBox shadow">
            ...
            <RecentTable entity={"job"} name="close" dataTableColumns={closeColumns} moveToNextTable={moveToNextTable} dOptions={dOptions} jobStatus={jobStatus} />
            <i className="bi bi-arrow-down" style={{ color: "black" }}></i>
          </div>
        </Col>
        <Col className="gutter-row" span={24}>
          <div className="whiteBox shadow">
            ...
            <RecentTable entity={"job"} name="audit" dataTableColumns={auditColumns} moveToNextTable={moveToNextTable} dOptions={dOptions} jobStatus={jobStatus} />
            <i className="bi bi-arrow-down" style={{ color: "black" }}></i>
          </div>
        </Col>
        <Col className="gutter-row" span={24}>
          <div className="whiteBox shadow">
            ...
            <RecentTable entity={"job"} name="finished" dataTableColumns={finishedColumns} moveToNextTable={moveToNextTable} dOptions={dOptions} jobStatus={jobStatus} />
            <i className="bi bi-arrow-down" style={{ color: "black" }}></i>
          </div>
        </Col>
        ...
        {modal && (
          <div className="modal">
            <div onClick={toggleModal} className="overlay" style={{
              background: "rgba(49,49,49,0.8)", width: "100vw",
              height: "100vh",
              top: 0,
              left: 0,
            ...
            <div className="modal-content" style={{
              ...
              <form role="form">
                ...
                <div className="form-group">
                  ...
                  <input type="text" className="form-control" id="name" placeholder="Enter Name" style={{ margin: "10px", padding: "4px", borderRadius: "6px", }} />
                </div>
                <div className="form-group">
                  <label for="name">Services</label>
                  <input type="text" className="form-control" id="service" placeholder="Enter Service" style={{ margin: "10px", padding: "4px", borderRadius: "6px", }} />
                </div>
                <div className="form-group">
                  <ReactStars
                    count={5}
              ...
              <button className="close-modal ant-btn ant-btn-primary" type="submit" style={{
                top: "10px",
                right: "10px",
                padding: "5px 8px"
              }} onClick={toggleModal}>
