...
export default function JobForm({ isUpdateForm = false, form }) {
  ...
  }, [vendorPrice, customService, budget, service, quantity, client]);
  ...
  return (
    <>
      ...
      >
        ...
        >
          {
            serviceFetch && (serviceFetch.length > 0) && serviceFetch.map(service => {
      ...
      <Form.Item name="quantity" style={{ display: "none" }}><Input /></Form.Item>
      <Form.Item name="vendorprice" style={{ display: "none" }}><Input /></Form.Item>
      <Form.Item name="customservice" style={{ display: "none" }}><Input /></Form.Item>
